   ...
   <nav class="navbar navbar-expand-lg border border-dark ">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="listsOptions.php" style="color: red;">Le Mie Liste</a>
                </li>
            </ul>
        </div>
    ...
    <div class="block md:flex justify-center md:-mx-2">
      <div class="w-full lg:w-1/3 md:mx-2 mb-4 md:mb-0">
        <div class="bg-white rounded-lg overflow-hidden shadow relative">
          <a href="bookRead.php">
          <img class="h-56 w-full object-contain object-center" src="../img/book_read.jpg" alt="">
          </a>
      ...
      <div class="w-full lg:w-1/3 md:mx-2 mb-4 md:mb-0">
        <div class="bg-white rounded-lg overflow-hidden shadow relative">
          <a href="bookDesired.php">
          <img class="h-56 w-full object-contain object-center" src="../img/book_desired.png" alt="">
          </a>
          <div class="p-4 h-auto md:h-40 lg:h-48">
            <a class="block text-black hover:no-underline hover:text-black font-semibold mb-2 text-lg md:text-base lg:text-lg text-center">
              Libri Desiderati
